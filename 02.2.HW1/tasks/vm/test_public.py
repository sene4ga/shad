...
import function_type_ban  # noqa
import cases  # noqa
import vm_scorer  # noqa
import vm_runner  # noqa
...
def test_version() -> None:
    assert "3.13.7" == sys.version.split(" ", maxsplit=1)[0], "To do this task you need python=3.13.7"
