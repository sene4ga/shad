...
* Документация к dis: https://docs.python.org/release/3.13.7/library/dis.html#module-dis. Там описаны все существующие операции байткода питона.
...
* Исходный код интерпретатора CPython - поможет разобраться с тонкостями:
  - https://github.com/python/cpython/blob/3.13/Python/ceval.c.
  - https://github.com/python/cpython/blob/3.13/Python/generated_cases.c.h
